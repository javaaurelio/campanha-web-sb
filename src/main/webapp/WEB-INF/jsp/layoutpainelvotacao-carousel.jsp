			...
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title">
						Votacao - <i class="bi bi-grid idMetadadosVoto"></i>
					</h5>
				</div>
				<div class="modal-body">
					...
					<form id="formVoto" data-metadadosvoto=""
						...
						<div id="carouselExampleControls" class="carousel slide"
							...
							<div class="carousel-inner">
								<div class="carousel-item active">
									...
									<div class="col-md-9">
										...
										<div class="input-group col-md-4">
											<span class="input-group-text codigoCampanha"></span> <input
												type="text" class="form-control nomePessoa"
												id="validationCustom01" size="50" maxlength="150" value=""
												required>
										</div>
									</div>
									...
									<div class="col-md-3">
										...
										<div class="input-group col-md-4">
											<input type="number" class="form-control idade"
												id="validationCustom01" value="" required maxlength="2">
										</div>
									</div>
										...
										<div class="col-mb-10">
											...
											<div class="form-check">
												<input class="form-check-input sexo" type="radio"
													name="sexo" id="gridMasculino" value="M" checked="checked">
											...
											<div class="form-check">
												<input class="form-check-input sexo" type="radio"
													name="sexo" id="gridFeminino" value="F"> <label
									...
									<div class="col-md-8">
										<label for="validationCustom01" class="form-label">Cidade
										</label>
										<div class="input-group col-md-4">
											<span class="input-group-text codigoCampanha"></span> <input
												type="text" class="form-control cidade"
												id="validationCustom01" size="50" maxlength="150" value=""
												required>
										</div>
									</div>
									...
									<div class="col-md-4">
										...
										<div class="input-group col-md-4">
											...
											<select class="form-select uf" id="validationCustom04"
												required>
								...
								<div class="carousel-item">Obrigado</div>
							</div>
